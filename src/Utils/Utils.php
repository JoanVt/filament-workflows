...
class Utils
{
    ...
    {
        $classes = [];
        $modelsConfig = config('workflows.models', [
        ...
        foreach ($modelsConfig as $modelConfig) {
            ...
            $directoryPath = str_replace('\\', '/', $modelConfig['path']);
            ...
            $classes = array_merge($classes, self::scanDirectoryRecursively($directoryPath, $namespace, $trait));
        }
